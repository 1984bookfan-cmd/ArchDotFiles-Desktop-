...
# Step 1: immediately output a blank placeholder for Waybar
placeholder = {"text": " "}  # can be "…" if you prefer
print(json.dumps(placeholder))
sys.stdout.flush()  # force Waybar to render it

# Step 2: now do the real work
try:
    weather = requests.get("https://wttr.in/?format=j1").json()
except Exception:
    # If request fails, exit; Waybar keeps the placeholder
    sys.exit(0)
